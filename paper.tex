...
The edit ratio also behaves on a similar manner in comparison with the Mylyn data but the effect is less pronounced and we can see more variation on the boxes. Still, the median changes accordingly with the number of interruptions, decreasing when there are more and reaching the maximum when there are none.
