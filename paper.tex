...
The sessions with UDC went through the same process of transformation into 10 chunks of equal time. The results on the Figure \ref{fig:bins_int_udc} shows similar patterns to the ones we observed in Mylyn.
\begin{figure}[!ht]
\centering
\begin{tabular}{c}
