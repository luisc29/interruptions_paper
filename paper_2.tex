...
\begin{table}[ht!]
	...
	\begin{tabular}{l | p{0.75cm} | p{1.2cm} | p{1.2cm} | p{1.2cm} |p{1.2cm}} 
		...
		\cline{3-6} 
		Cliff's delta & $\hookrightarrow$ & \textbf{0.19} & \textbf{0.24} & \textbf{0.28} & \textbf{-0.46} \\ 
		\hline
...
\begin{table}[ht!]
	...
	\begin{tabular}{l | p{1cm} | p{1cm} | p{1cm} | p{1cm} | p{1cm} | p{1cm} | p{1cm}} 
		...
		\hline
		Cliff's delta & 0.36 & 0.26 & 0.23 & 0.16 & 0.26 & 0.08 & -0.09 \\
		\hline
		...
		\hline
		Cliff's delta & 0.22 & 0.16 & 0.17 & 0.20 & 0.03 & 0.16 & 0.18  \\  
		\hline
		...
		\hline 
		Cliff's delta & 0.28 & 0.23 & 0.15 & 0.03 & 0.20 & -0.06 & -0.17  \\
		\hline
...
\begin{tabular}{l | p{0.7cm} | p{1.9cm} | p{1.9cm} } 
  ...
  \cline{3-4} 
   Cliff's delta & $\hookrightarrow$	& \textbf{-0.01} & \textbf{-0.32}   \\
  \hline
  ...
  \cline{3-4} 
  Cliff's delta & $\hookrightarrow$	& \textbf{0.32} & \textbf{-0.08}  \\  
\end{tabular}
\end{table}
