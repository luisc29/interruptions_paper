...
\begin{table}[ht!]
	...
	\begin{tabular}{l | p{0.75cm} | p{1.2cm} | p{1.2cm} | p{1.2cm} |p{1.2cm}} 
		...
		\cline{3-6} 
		p-values adjust  & $\hookrightarrow$& \multicolumn{4}{c}{$<$ 2.2e-16} \\
		\hline
		\multicolumn{6}{c}{\textbf{Selections}} \\
		\hline 
		...
		\cline{3-6} 
		p-values adjust  & $\hookrightarrow$& \multicolumn{4}{c}{$<$ 0.0001} \\
		\hline
