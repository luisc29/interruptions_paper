...
\begin{table}[ht!]
	...
	\begin{tabular}{l | p{1cm} | p{1cm} | p{1cm} | p{1cm} | p{1cm} | p{1cm} | p{1cm}} 
		...
		\hline
		Cliff's delta & 0.36 & 0.28 & 0.23 & 0.16 & 0.26 & 0.08 & -0.09 \\
		\hline
...
\begin{table}[ht!]
	...
	\begin{tabular}{l | p{1cm} | p{1cm} | p{1cm} | p{1cm} | p{1cm} | p{1cm} | p{1cm}} 
		...
		\hline
		Cliff's delta & 0.36 & 0.28 & 0.22 & 0.16 & 0.26 & 0.08 & -0.09 \\
		\hline
		...
		\hline
		Cliff's delta & 0.22 & 0.17 & 0.17 & 0.20 & 0.03 & 0.16 & 0.17 \\  
		\hline
		...
		\hline 
		Cliff's delta & 0.28 & 0.23 & 0.15 & 0.03 & 0.20 & -0.06 & -0.16  \\
		\hline
