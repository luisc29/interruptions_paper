...
Category \emph{refactoring} regroups usage of refactorings tools (rename, move methods, extract methods, etc). This is indicative of edition activities \RR{expand}

Category \emph{clean-build} regroup events related to build system usage (build the system, clean the build, run the build, the tests, etc). This is indicative of \RR{out of inspiration and time for now ...}
